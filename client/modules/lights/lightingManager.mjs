...
class LightingManager {
    ...
    constructor(scene) {
        ...
        let sun = new OrbitingLight(scene, 0, new THREE.Vector3(0, 50, 100), 100, [
            ...
            { angle: tau * .25, color: 0xffddaa, intensity: 0.8 },
            { angle: tau * .45, color: 0xfffeea, intensity: 1.0 },
            { angle: tau * .60, color: 0xffcc66, intensity: 1.0 },
            { angle: tau * .75, color: 0xffaa33, intensity: 0.8 },
