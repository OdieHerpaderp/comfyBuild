...
// to keep the chain going. each tool always uses new materials and the last version of tools to make em.
  ...
  // first farming. note, it takes wild grains to build, gives actual wheat. thus replacing wildgrains for wheat in your bread production.
  ...
  // introduces brick, an upgrade over mudbrick
  brickery: {
    age: 3,
