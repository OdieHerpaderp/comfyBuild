...
const buildings = {
  ...
  mudBrickHouse: {
    ...
    build: { stone: 3, brick: 4, toolFlint: 2 },
...
//  },
  ...
  limestoneKiln: {
    ...
    build: { stone: 8, clay: 6, fuel: 4 },
    consume: { limestone: 8, fuel: 6 },
    produce: { quicklime: 6 }
  },
  lyeVats: {
    age: 4,
...
//  },
  ...
  leadedGlassBlower: {
    ...
    consume: {sand: 8, fuel: 3, leadIngot: 1 },
    produce: { glass: 10 }
  },
  ...
  ironMine: {
    ...
    node: "ironDeposit",
    build: { wood: 8, stone: 6, toolBronze: 1 },
