...
const buildings = {
  ...
  flintKnapper: {
    ...
    consume: { stone: 3, plantFibre: 2 },
    produce: { toolPrimitive: 2, club: 2 }
  },
  forestry: {
    age: 0,
    category: "gatheringOrganics",
  ...
  woodWorker: {
    ...
    produce: { toolPrimitive: 2, bucket: 1, club: 2 }
  },
  huntersCamp: {
    age: 0,
    category: "gatheringOrganics",
  ...
  flaxFarm: {
    ...
    node: "soil",
    build: { wood: 3, mud: 1 },
    consume: { water: 3, toolPrimitive: 1 },
    produce: { flax: 2 }
  },
  linenMill: {
    age: 3,
  ...
  coppersmith: {
    ...
    build: { wood: 4, stone: 6, copperIngot: 2 },
    consume: { copperIngot: 2, charcoal: 1 },
    produce: { toolNeolithic: 3 }
  },
  arrowCrafter: {
    age: 4,
