...
const buildings = {
  ...
  // age 1 gives acces to stone and wood
  dolmen: {
    age: 1,
    category: "housing",
  ...
  // wonders. for now they do nothing but be expensive.

  // todo: maybe remove headquarters as a building and make it the age0 wonder.
  headquartersAlt: {
    age: 1,
    category: "wonder",
    info: "mysterious rectangle with helmets on it. did aliens visit here? more on the history channel after these adds.",
    build: {},
    consume: {},
    produce: { odiePoints: 0 }// score points go up. todo: discuss if these buildings even need to do anything usefull.
  },
  chauvetCave: {
    age: 2,
    category: "wonder",
    info: "c. 30,000 BC France. This cave contains some of the earliest known prehistoric cave paintings, depicting animals such as ibex, mammoths, horses, lions, and bears.",
    node: "rockDeposit",
    build: { toolBlunt: 50, game: 50, plantFibre: 300 }, // no idea what wonders should cost rn. i'm assuming they should be 'spensive.
    consume: {},
    produce: { odiePoints: 1 }// score points go up. todo: discuss if these buildings even need to do anything usefull.
  },
  lascauxCave: {
    age: 3,
    category: "wonder",
    info: "c. 17,000 BC France. Known as the 'Sistine Chapel of Prehistory,' it features nearly 6,000 figures, including animals, human figures, and abstract signs.",
    build: { toolFlint: 50, game: 150, mud: 200, clay: 100 },
    consume: {},
    produce: { odiePoints: 2 }// score points go up. todo: discuss if these buildings even need to do anything usefull.
  },
  göbekliTepe: {
    age: 4,
    category: "wonder",
    info: "c. 9600 BC Turkey. An archaeological site with massive stone pillars arranged in circles, considered the world's oldest known temple.",
    build: { toolFlint: 100, limestone: 150, clay: 150, sheep: 50, turtle: 50 },
    consume: {},
    produce: { odiePoints: 3 }// score points go up. todo: discuss if these buildings even need to do anything usefull.
  },
  newgrange: {
    age: 5,
    category: "wonder",
    info: "c. 3200 BC Ireland. A prehistoric monument in County Meath, consisting of a large circular mound with an inner stone passageway and chambers.",
    build: { toolFlint: 150, stone: 300, quartz: 100, mudBrick: 150, cloth: 200 },
    consume: {},
    produce: { odiePoints: 4 }// score points go up. todo: discuss if these buildings even need to do anything usefull.
  },
  stoneHenge: {
    age: 6,
    category: "wonder",
    info: "c. 3000 BC United Kingdom. A prehistoric monument consisting of a ring of standing stones, located in Wiltshire, England.",
    build: { toolFlint: 200, stone: 100, limestone: 100, lumber: 100, rope: 50, herb: 50, alcohol: 50 },
    consume: {},
    produce: { odiePoints: 5 }// score points go up. todo: discuss if these buildings even need to do anything usefull.
  },
  greatPyramidOfGiza: {
    age: 7,
    category: "wonder",
    info: "c.2560 BC Egypt. The oldest and only surviving ancient wonder, a massive pyramid built as a tomb for Pharaoh Khufu.",
    build: { toolCopper: 50, stoneBlock: 400, limeMortar: 200, goldDecor: 100, rope: 50, lumber: 50 },
    consume: {},
    produce: { odiePoints: 6 }// score points go up. todo: discuss if these buildings even need to do anything usefull.
  },
  greatWallOfChina: {
    age: 8,
    category: "wonder",
    info: "Since 7th century BC China. A series of fortifications made of various materials, built to protect against invasions.",
    build: { toolBronze: 50, stoneBlock: 800, limeMortar: 400, shingle: 200, wagon: 50 },
    consume: {},
    produce: { odiePoints: 7 }// score points go up. todo: discuss if these buildings even need to do anything usefull.
  },
  hangingGardensOfBabylon: {
    age: 9,
    category: "wonder",
    info: "c. 600 BC Iraq. Fabled terraced gardens, possibly built by King Nebuchadnezzar II, though their existence is not definitively proven.",
    node: "soil",
    build: { toolBronze: 100, brick: 300, limeMortar: 200, water: 3000, mud: 2000, glass: 100, bronzeDecor: 100 },
    consume: {},
    produce: { odiePoints: 8 }// score points go up. todo: discuss if these buildings even need to do anything usefull.
  },
  ColossusOfRhodes: {
    age: 10,
    category: "wonder",
    info: "c. 292 BC Greece. A giant bronze statue of the sun god Helios, erected to celebrate Rhodes' victory over Cyprus.",
    build: { toolIron: 50, bronzeIngot: 2000, marble: 200, concrete: 500, ship: 200 },
    consume: {},
    produce: { odiePoints: 9 }// score points go up. todo: discuss if these buildings even need to do anything usefull.
  },
  lighthouseOfAlexandria: {
    age: 11,
    category: "wonder",
    info: "c. 280 BC	Egypt. Also known as the Pharos of Alexandria, it was a towering lighthouse guiding sailors safely to the harbor.",
    build: { toolIron: 100, marble: 300, brick: 300, concrete: 600, ship: 200, paper: 3000 },
    consume: {},
    produce: { odiePoints: 10 }// score points go up. todo: discuss if these buildings even need to do anything usefull.
  },
  theColosseum: {
    age: 11,
    category: "wonder",
    info: "Completed AD 80 Italy. An ancient amphitheater in Rome, known for hosting gladiatorial contests and public spectacles.",
    build: { toolIron: 150, marble: 1000, concrete: 600, lumber: 100, leadPipe: 100, lion: 50 },
    consume: {}, // consumes christians for faith and entertainment :P
    produce: { odiePoints: 10 }// score points go up. todo: discuss if these buildings even need to do anything usefull.
  },

  // 

  // Age 1 age of scavenging
  ...
  // Age 2, advent of fire and hunting
  ...
  handMiller: { // rewritten to match new recipe style. 
    age: 2,
    category: "processingOrganics",
    ...
    build:
      [
        { name: "wood", amount: 5 },
        { name: "stone", amount: 9 },
        { name: "toolBlunt", amount: 1 }
      ],
    recipes: [{
      consume: [
        { name: "wildGrains", amount: 3 },
        { name: "toolBlunt", amount: 2 }
      ],
      produce: [
        { name: "flour", amount: 3 },
  ...
  handMiller1: { // remove when handMiller is working properly
    age: 2,
    category: "processingOrganics",
    info: "Harnesses manual labour to mill grains.",
  ...
  handMiller2: { // remove when handMiller is working properly
    age: 2,
    info: "Harnesses manual labour to mill grains.",
    build: { wood: 5, stone: 9, toolBlunt: 1 },
  ...
  // Age 3 peak stoneage, time for flint tools
  ...
  fishStove: {
    ...
    requiredResearch: ["combustion" , "fishing1"]
  },
  ...
  // Age 4 flint tools are phased out for quartz and obsidian. 
  ...
  // Age 7 first culture buildings & deeper mines
  ...
  // i noticed you made a sandstone building. but we hadn't used sandstone yet. i'mm adding it here for now
  sandStoneQuarry: {
    age: 7,
    category: "gatheringMinerals",
    info: "mines stone from sandstone deposits in quarries and cuts them for construction.",
    node: "rockDeposit",
    build: { lumber: 4, mudBrick: 6, toolCopper: 1 },
    consume: { toolCopper: 1 },
    produce: { sandStone: 8 } // stone: 4
  },
  sandStoneCutters: {// this way the pyramids can cannonically be made of standstone blocks. yay
    age: 7,
    category: "gatheringMinerals",
    info: "Skilled masons work with chissels and saws to perfectly cut sandstone blocks for construction, and large mills to grind everything else down",
    node: "rockDeposit",
    build: { lumber: 4, mudBrick: 6, toolCopper: 1 },
    consume: { toolCopper: 1, sandStone: 10 },
    produce: { sand: 20, stoneBlock: 10 }
  },
  ...
  // a proposal for the age 8 trade building.
  //  primitiveMint: {
  //    age: 8,
  ...
  toxicToxotai: {
    ...
    produce: { game: 15, bird: 5, lion: 1 } // lion is kinda a joke. depends where we wanna go with hunting. it goes into making the colloseum in age 11 tho.
  },



  // age 9: late bronze age
...
function countBuildingsByAge() {
  ...
  for (const buildingName in buildings) {
    const age = buildings[buildingName].age ?? 0;
    ageCount[age] ??= 0;
    ageCount[age]++;
    ageTotal++;
  }
