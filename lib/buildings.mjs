...
const buildings = {
  ...
  mudBrickHouse: {
    ...
    consume: { water: 3, fish: 5, rootVegetable: 5, hide: 2 },
  ...
  bungalow: {
    ...
    build: { stone: 8, wood: 9, toolFlint: 3 },
  ...
  ziggurat: { // INFO: should match the Ancient age, as it is built by the mesopotamians. see the notes file for additional information.
    age: 8,
    category: "housing",
    info: "A monumental stepped mudBrick temple-tower from ancient Mesopotamia.",
    build: { mudBrick: 12, wood: 8, stone: 4, toolCopper: 2 },
    consume: { water: 6, bread: 6, salad: 6, egg: 5, milk: 5, poultry: 3, alcohol: 3, clothing: 1 },
    produce: { population: 48 }
  },
  /*
  zigguratAlt: {
    age: 8,
  ...
  */
  ...
  // temp solution to not needing sand enough
  sandCastleBuilder: {
    age: 1,
    info: "Harnesses manual labour to toil on the beach.",
    build: { wood: 5, toolBlunt: 1 },
    consume: { sand: 20},
    produce: { faith: 1 }
  },
  ...
  stoneCuttingQuarry: {
    ...
    build: { wood: 4, stone: 6, toolFlint: 1 },
    consume: { toolFlint: 1 },
    produce: { stone: 4, stoneBlock: 4 , flint: 2}
  },
  // TODO: place in correct age (roman), and possibly replace stoneBlock with marble.
  aqueduct: {
    age: 3,
    node: "freshWater",
    build: { stoneBlock: 12, toolFlint: 1 },
    consume: { bucket: 1, toolFlint: 1 },
    produce: { water: 12 }
  },
...
// next tier food buildings
  ...
  // INFO: nets could be placed earlier
  knittingWorkshop: {
    age: 8,
    category: "processingOrganics",
    info: "Twists and plies plant fibres into rope and cordage.",
    build: { lumber: 6, brick: 6 },
    consume: { rope: 5 },
    produce: { net: 1 }
  },
  ...
  frogPond: {
    ...
    build: { stone: 3, wood: 3, plantFibre: 3, toolFlint: 1 },
    consume: { frog: 7, toolFlint: 1 },
    produce: { frog: 9, faith: 1 } // water: 2, clay: 2, plantFibre: 6, 
  },
  turtlePond: {
    age: 8,
    node: "freshWater",
    ...
    build: { stone: 3, wood: 3, plantFibre: 3, toolFlint: 1 },
    consume: { turtle: 7, toolFlint: 1 },
    produce: { turtle: 9, faith: 1 } // water: 2, clay: 2, plantFibre: 6, 
  },
