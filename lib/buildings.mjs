...
const buildings = {
  ...
  boneTent: {
    ...
    build: { plantFibre: 2, bone: 2, hide: 2, toolFlint: 1 },
  ...
  hut: {
    ...
    build: { wood: 3, plantFibre: 2, mud: 2, toolFlint: 2 },
  ...
  mudBrickHouse: {
    ...
    build: { stone: 3, bricks: 4, toolFlint: 2 },
  ...
  bungalow: {
    ...
    build: { stone: 6, wood: 9, toolFlint: 3 },
  ...
  clayBrickHouse: {
    ...
    build: { stone: 6, brick: 12, wood: 1, toolCopper: 2 },
  ...
  ziggurat: {
    ...
    build: { brick: 22, wood: 8, stone: 4, toolBronze: 2 },
  ...
  raidingCamp: {
    ...
    consume: { militia: 1 },
    produce: { plantFibre: 1, berry: 1, rootVegetable: 1, wildGrains: 1, game: 1, fish: 1, fuel: 1, pottery: 1, bucket: 1, brick: 1 } // can we randomise output a little?
  },
  quartzMine: {
    age: 3,
  ...
  chickenCoop: {
    ...
    produce: { bird: 1, eggs: 4, feather: 2 }
  },
  fletcher: {
    age: 3,
  ...
  nuggetGatherers: {
    ...
    build: { stone: 3, wood: 3, plantFibre: 3 },
    consume: { population: 6, pottery: 1 },
  ...
  tinSmelter: {
    ...
    consume: { population: 3, tinOre: 5, fuel: 3 },
    produce: { tinIngot: 4 }
  },
  silverSurfaceMine: {
    age: 4,
    ...
    build: { population: 4, wood: 10, stone: 12, toolCopper: 2 },
    consume: { population: 6, toolCopper: 3 },
  ...
  bowyer: {
    ...
    consume: { population: 2, lumber: 2, fleching: 3, string: 2 },
    produce: { bow: 2 }
  },
  mortuary: {
    age: 4,
  ...
  limestoneKiln: {
    ...
    build: { population: 2, stone: 8, clay: 6, fuel: 4 },
    consume: { population: 4, limestone: 8, fuel: 6 },
    produce: { quicklime: 6 }
  },
  lyeVats: {
    age: 4,
    ...
    consume: { population: 3, ash: 6, water: 4, limestone: 2 },
    produce: { lye: 4 }
  },
  rainCollector: {
    age: 4,
  ...
  distillery: {
    ...
    consume: { water: 4, hops: 3, toolCopper: 1, fuel: 2 },
  ...
  zincSmelter: {
    ...
    build: { population: 2, stone: 8, clay: 4 },
    consume: { population: 3, zincOre: 5, fuel: 3 },
    produce: { zincIngot: 4 }
  },
  silverSmelter: {
    age: 5,
    ...
    build: { population: 2, stone: 8, clay: 4 },
    consume: { population: 3, silverOre: 5, fuel: 3 },
  ...
  goldSmelter: {
    ...
    build: { population: 2, stone: 8, clay: 4 },
    consume: { population: 3, goldOre: 5, fuel: 3 },
    produce: { goldIngot: 4 }
  },
  leadSmelter: {
    age: 5,
  ...
  primitiveSilverJeweler: {
    ...
    build: { population: 2, stone: 8, clay: 4 },
    consume: {silverIngot: 5, quartz: 2, fuel: 3 },
  ...
  primitiveGoldJeweler: {
    ...
    info: "Crafts simple decorations from soft metals and rough gems.",
    build: { population: 2, stone: 8, clay: 4 },
    consume: {goldIngot: 5, quartz: 2, fuel: 3 },
    produce: { goldDecor: 3 }
  },
  birdRelocation: {
  age: 5,
  ...
  glassBlower: {
    ...
    build: { population: 3, clay: 12, brick: 8, toolCopper: 2 },
    consume: { population: 5, sand: 6, fuel: 2 },
    produce: { glass: 4 }
  },
  greenHouse: {
    age: 5,
  ...
  build: {toolCopper:1, brick: 4, clay: 2, population:1},
    consume: {clay: 4},
    produce: {tablet: 1},
  },
  beanCounters: {
  ...
  bronzeSmelter: {
    ...
    consume: { copperIngot: 4, tinIngot: 1, fuel: 3 },
  ...
  brassSmelter: {
    ...
    build: { brick: 8, clay: 4 },
    consume: { copperIngot: 3, zincIngot: 2, fuel: 3 },
  ...
  pewterSmelter: {
    ...
    build: { brick: 8, clay: 4 },
    consume: { copperIngot: 1, tinIngot: 3, leadIngot: 1, fuel: 3 },
  ...
  whiteSmith: {
    ...
    build: { lumber: 6, brick: 8, shingle: 3 },
    consume: { pewterIngot: 3, tinIngot:1, fuel: 2 },
  ...
  primitiveMint: {
    ...
    consume: { electrumIngot: 3, fuel: 3 },
    produce: { tempLogisticsLaborPoints: 30 }
  },
  ...
  windmill: {
    ...
    build: { population: 2, lumber: 4, brick: 6, rope: 3, sail: 4},
    consume: { wheat: 12 },
    produce: { flour: 11 }
  },
  ...
  goldEnricher: {
    ...
    consume: { electrumIngot: 3, salt: 3 , fuel: 1, ironOre:1, sulfur:1},
  ...
  Mint: {
    ...
    build: { wood: 6, stone: 8, leadIngot: 3, toolBronze: 3 },
    consume: { electrumIngot: 1, silverIngot: 1, goldIngot: 1, copperIngot: 1, fuel: 3 }, 
    produce: { tempLogisticsLaborPoints: 50 }
  },
  paintedPotteryKiln: {
    age: 7,
    info: "Uses paints and pigments to make beautifull works of art.",
    build: { brick: 3, lumber: 2, lumber: 2, toolBronze: 1 },
    consume: { clay: 12, fuel: 3 , silverChloride: 1, leadIngot: 1, bronzeDecor: 1},
    produce: { pottery: 20,  faith: 1 }
  },
  leadedGlassBlower: {
    age: 7,
    info: "Crafts reinforced glass products like windows, bottles, lenses etc.",
    build: { population: 3, clay: 12, brick: 8, toolBronze: 2 },
    consume: { population: 5, sand: 8, fuel: 3, leadIngot: 1 },
    produce: { glass: 10 }
  },
  ...
  clockmaker: {
    ...
    build: { population: 4, lumber: 8, brick: 10, shingle: 6, glass: 1 },
    consume: { population: 6, brassIngotIngot: 3, glass: 2 },
    produce: { clock: 1 }
  },
  pulpMill: {
    age: 8,
  ...
  paperMill: {
    ...
    node: "ironDeposit",
    build: { population: 3, wood: 8, stone: 6, toolBronze: 1 },
    consume: { population: 4, toolBronze: 1, candle: 1 },
    produce: { ironOre: 4 }
  },
  ironSmelter: {
    age: 8,
    info: "Smelts iron ore into metal ingots using high heat.",
    build: { population: 3, stone: 12, clay: 6, toolBronze: 1, shingle: 2 },
    consume: { population: 4, ironOre: 6, fuel: 4 },
    produce: { ironIngot: 5 }
  },
  papyrusField: {
    age: 8,
