...
var buildings = {
  ...
  boneTent: {
    ...
    consume: { water:2, berry:4, meat: 4 },
  ...
  hut: {
    ...
    build: { wood: 3, plantFibre: 2, mud: 2, toolPrimitive: 1 },
    consume: { water:3, meat: 6, rootVegetable: 5 },
  ...
  mudBrickHouse: {
    ...
    build: { stone: 3, mudBricks: 4, toolPrimitive: 1 },
  ...
  potteryKiln: {
    ...
    consume: { population: 3, clay: 8, charcoal: 3 },
  ...
  limestoneQuarry: {
    ...
    node: "stoneDeposit",
    build: { population: 3, wood: 4, stone: 6, toolPrimitive: 1 },
