...
const buildings = {
  ...
  woodHut: { // todo: needs a good name, alternative to hut above, uses bread
    age: 2,
    category: "housing",
  ...
  eneolithicAgeHut3: { //todo: needs a real name and info. introduces new stoneblock material, upperclass
    age: 6,
    category: "housing",
    info: "Stoneblock houses at the cusp of going into the bronze age.",
    build: { stoneBlock: 8, lumber: 8, limeMortar: 4, goldDecor: 1 },
  ...
  */
  ...
  rainCollector: {
    ...
    build: { lumber: 4, copperIngot: 1, brick: 3 },
    consume: {},
    produce: { water: 1 }
  },
  ...
  shinyShrine: {
    ...
    build: { lumber: 6, stoneBlock: 2, brick: 5 },
