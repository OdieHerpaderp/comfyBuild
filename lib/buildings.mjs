...
const buildings = {
  ...
  mudBrickHouse: {
    ...
    consume: { water: 3, meat: 7, wheat: 5, rootVegetable: 2 },
  ...
  burdei: {
    ...
    consume: { water: 3, meat: 5, salad: 6, rootVegetable: 3 },
  ...
  bungalow: {
    ...
    consume: { water: 4, meat: 11, bread: 4, salad: 4 },
  ...
  clayBrickHouse: {
    ...
    consume: { water: 5, meat: 13, bread: 6, salad: 4 },
  ...
  ironMine: {
    ...
    consume: { population: 4, toolNeolithic: 1 },
    produce: { ironOre: 3 }
  },
  silverMine: {
    age: 6,
    info: "Mines silver ore from rich veins.",
    build: { wood: 10, stone: 12, toolNeolithic: 2 },
  ...
  shipWright: {
    ...
    consume: { copperIngot: 8, tinIngot: 8, ironIngot: 8, glass: 3, wood: 24, sail: 2 },
    produce: { ship: 1 }
  },
}
