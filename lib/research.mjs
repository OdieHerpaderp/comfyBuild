const research = {
  ...
  foodPreperation1: {
    age: 2,
    fullName: "Food Preparation I",
    info: "Unlocks the preparation of meat from game.",
    cost: 1000,
    requiredResearch: ["fire", "tools1"]
  },
  combustion: {
  ...
  fishing1: {
    age: 3,
    fullName: "Fishing I",
    info: "Unlocks harpoon/spear fishing.",
    cost: 2000,
    requiredResearch: []
  },
  soilGathering1: {
    age: 3,
    fullName: "Soil Gathering I",
    info: "Unlocks harvesting soils like clay, mud, and sand.",
    cost: 2000,
    requiredResearch: []
  },
  pottery: {
